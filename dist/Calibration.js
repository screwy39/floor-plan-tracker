export class Calibration {
     ...
     */
    static computeFromTwoPoints(point1Image, point2Image, realWorldDistanceMeters, originImage) {
     ...
     */
    static worldToImage(worldX, worldY, calibration) {
     ...
     */
    static imageToWorld(imageU, imageV, calibration) {
        // Translate to origin
