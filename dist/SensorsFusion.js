...
export class SensorsFusion {
     ...
     */
    static async captureWifiFingerprintOrScan() {
     ...
     */
    static async getExternalPositionEstimate() {
     ...
     */
    static computeCorrection(deadReckoningPose, externalEstimate, references, calibration, correctionMode) {
        if (correctionMode === "manual-only")
            return null;
        // Filter by source if needed
        if (correctionMode === "wifi-only" && externalEstimate.source !== "wifi") {
            return null;
        }
        const worldPos = ReferencePoints.externalEstimateToWorld(externalEstimate, references, calibration);
        if (!worldPos)
            return null;
...
//# sourceMappingURL=SensorsFusion.js.map